    ...
    function ftc_tiny_account()
    {
        ...
        <div class="ftc-tiny-account-wrapper">
            <div class="account-control">
                <?php if (!$_user_logged): ?>
                    <a class="login" href="<?php echo esc_url($login_url); ?>"
                            ...
                            <div class="account-dropdown-form dropdown-container">
                                <div class="form-content">
                                    ...
                                    <p class="login-username">
                                        <label><?php echo esc_html('Username', 'corona'); ?></label>
                                        <input type="text" name="log" class="input" value="" size="20" autocomplete="off">
                                    </p>
                                    <p class="login-password">
                                        <label><?php echo esc_html('Password', 'corona'); ?></label>
                                        <input type="password" name="pwd" class="input" value="" size="20">
                                    </p>

                                    <p class="login-submit">
                                        <input type="submit" name="wp-submit" class="button-secondary button"
                                        value="<?php echo esc_html('Login', 'corona'); ?>">
                                        <input type="hidden" name="redirect_to" value="<?php echo home_url($redirect_to); ?>">
                                    </p>

                                </form>

                                <p class="forgot-pass"><a href="<?php echo esc_url(wp_lostpassword_url()); ?>"
                                  title="<?php echo esc_html('Forgot Your Password?', 'corona'); ?>"><?php echo esc_html('Forgot Your Password?', 'corona'); ?></a>
                              </p>
                          </div>
                      </div>
                  <?php endif; ?>
    ...
    <?php if(isset($smof_data['ftc_mobile_layout']) && $smof_data['ftc_cart_layout'] == 'off-canvas'): ?>
        <div class="ftc-off-canvas-cart">
            <div class="off-canvas-cart-title">
                <div class="title"><?php echo esc_html('Shopping Cart', 'corona'); ?></div>
                <a href="#" class="close-cart"> <?php echo esc_html('Close', 'corona') ?></a>
            </div>
