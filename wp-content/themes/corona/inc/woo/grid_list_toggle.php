	...
	class Ftc_Grid_List{
		...
		function gridlist_toggle_button() {
			...
			<nav class="gridlist-toggle">
				<a href="#" id="grid" title="<?php echo esc_html('Grid view', 'corona'); ?>">&#8862; <span><?php echo esc_html('Grid view', 'corona'); ?></span></a><a href="#" id="list" title="<?php echo esc_html('List view', 'corona'); ?>">&#8863; <span><?php esc_html_e('List view', 'corona'); ?></span></a>
			</nav>
			<?php
		}
