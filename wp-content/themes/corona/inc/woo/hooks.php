...
function ftc_template_product_size_chart_button() {
	...
	if (!empty($size_chart_image_product) || !empty($size_chart_image_options)) {
		...
		echo '<a class="ftc-size_chart" href="' . esc_url($ajax_url) . '"><i class="fa fa-table"></i> ' . esc_html__('Size Chart','corona') . '</a>';
	}
}
...
function ftc_template_loop_product_thumbnail(){
	...
	echo '<span class="'.(($has_back_image)?'has-more-image':'no-back-image').'">';
	if( !$lazy_load ){
...
function ftc_template_before_single_social_sharing(){
	...
	<div class="social-sharing">
		<div class="print">
			<a href="javascript:window.print()" rel="nofollow"><i class="fa fa-print"></i><?php esc_html_e('Print', 'corona') ?></a>
		</div>
		<div class="email">
			<a href="mailto:?subject=<?php echo esc_attr(sanitize_title(get_the_title())); ?>&amp;body=<?php echo esc_url(get_permalink()); ?>">
				<i class="fa fa-envelope"></i>
				<?php esc_html_e('Email to a Friend', 'corona') ?>
			</a>
		</div>
...
if( class_exists('YITH_WCWL') ){
	function ftc_add_wishlist_button_to_product_list(){
		...
		echo '<a href="'.esc_url($wishlist_url).'"><i class="fa fa-heart"></i><span class="ftc-tooltip button-tooltip">'.esc_html__('Added', 'corona').'</span></a>';
		echo '</span>';
		
		echo '<span class="yith-wcwl-wishlistexistsbrowse '.($exists?'show':'hide').'" style="'.($exists?'':'display: none').'">';
		echo '<a href="'.esc_url($wishlist_url).'"><i class="fa fa-heart"></i><span class="ftc-tooltip button-tooltip">'.esc_html__('Existed', 'corona').'</span></a>';
		echo '</span>';
