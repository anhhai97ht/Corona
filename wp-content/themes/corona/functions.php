...
/* * * back ground top ** */
if (!function_exists('ftc_background_top')) {

    function ftc_background_top() {
        global $smof_data;
        $bg_image = isset($smof_data['ftc_background_top']['url']) ? esc_url($smof_data['ftc_background_top']['url']) : '';
        
        ?>
        <?php if (strlen($bg_image) > 0): ?>
            <img src="<?php echo esc_url($bg_image); ?>"  class="background-top" class="img lazyloading" alt="banner" data-was-processed="true"/>
        <?php endif; ?>
        <?php
    }
}
        ...
        <?php if( !is_page_template('page-blank.php') ): ?>
            <div class="ftc-mobile-wrapper">
                ...
                <div class="mobile-menu-wrapper">
                   <?php 
                   wp_nav_menu( array( 'theme_location' => '', 'menu' => 'primary', 'menu_id' => 'main-menu', 'menu_class' => 'ftc-smartmenu ftc-simple') ); 
                   ?>
               </div>
...
function ftc_breadcrumbs_title($show_breadcrumb = false, $show_page_title = false, $page_title = '', $extra_class_title = ''){
    ...
    if ($show_breadcrumb || $show_page_title) {
        ...
        echo '<div class="breadcrumb-title-wrapper" ' . $style . '><div class="container"><div class="breadcrumb-title">';
        if ($show_page_title) {
...
function ftc_register_required_plugins()
{
    ...
    $plugins = array(
        ...
        'source'             => 'http://demo.themeftc.com/corona-woo/content/ftc-importer-corona-'.$version .'.zip', 
        'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ...
        , array(
        'name' => 'Woocommrce Variation Swatches', // The plugin name.
