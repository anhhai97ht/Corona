...
public function setSections() {
    ...
    $this->sections[] = array(
        ...
        'fields' => array(	
            ...
            array(
                'id'=>'ftc_background_top',
                'type' => 'media',
                'compiler'  => 'true',
                'mode'      => false,
                'title' => esc_html__('Background Image top header', 'corona'),
                'desc'      => esc_html__('Select an image file for the main background to top', 'corona'),
                'default' => array(
                    'url' => get_template_directory_uri(). '/assets/images/back-top.jpg'
                )
            ) 
            ,
            array(
            ...
            array(   "title"      => esc_html__("Check out", "corona")
                ,"desc"     => ""
...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(     "title"      => esc_html__("Ads Banner Content", "corona")
            ,"desc"     => ""
        ...
        array(  "title"      => esc_html__("Related - Up-Sell Products", "corona")
            ,"desc"     => ""
            ,"id"       => "introduction_related_upsell_product"
            ,"icon"     => true
            ,"type"     => "info"
        ),
        array(     "title"      => esc_html__("Up-Sell Products", "corona")
            ,"desc"     => ""
            ,"id"       => "ftc_prod_upsells"
            ,"default"      => 0
            ,"on"       => esc_html__("Show", "corona")
        ...
        array(  "title"      => esc_html__("Related Products", "corona")
            ,"desc"     => ""
            ,"id"       => "ftc_prod_related"
            ,"default"      => 1
            ,"on"       => esc_html__("Show", "corona")
