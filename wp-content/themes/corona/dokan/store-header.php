...
if ( ( 'default' === $profile_layout ) || ( 'layout1' === $profile_layout ) ) {
                 ...
                 class="profile-info-img">
                  ...
                  <div class="social-store">
                        ...
                        <li class="facebook">
                            ...
                            . get_the_permalink() ) ?> target="_blank" title="<?php echo esc_attr__('Facebook', 'corona'); ?>"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li class="twitter">
                            <a class="twitter social-icon" href=<?php echo esc_url('https://twitter.com/home?status='.get_the_title().' ' . get_the_permalink() ) ?> target="_blank" title="<?php echo esc_attr__('twitter', 'corona'); ?>"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li class="pinterest">
                            <a class="pinterest social-icon" href=<?php echo esc_url("https://www.pinterest.com/shareArticle?mini=true&url=" . get_the_permalink() ) ?> target="_blank" title="<?php echo esc_attr__('Pinterest', 'corona'); ?>"><i class="fa fa-pinterest-p"></i></a>
                        </li>
                        <li class="gplus">
                            <a class="gplus social-icon" href=<?php echo esc_url("https://plus.google.com/share?url="
                            . get_the_permalink() ) ?> target="_blank" title="<?php echo esc_attr__('Google +', 'corona'); ?>"><i class="fa fa-google-plus"></i></a>
                        </li>
                        <li class="linkedin">
                            <a class="linkedin social-icon" href=<?php echo esc_url("https://www.linkedin.com/shareArticle?mini=true&url=" . get_the_permalink() ) ?> target="_blank" title="<?php echo esc_attr__('Linkedin', 'corona'); ?>"><i class="fa fa-linkedin"></i></a>
                        </li>
                    </ul>
        </div>
                 </div>
