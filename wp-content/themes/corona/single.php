			...
			<?php
				...
				while ( have_posts() ) : the_post();
					...
					the_post_navigation( array(
						'prev_text' => '<span class="screen-reader-text">' . esc_html__( 'Previous Post', 'corona' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . esc_html__( 'Previous', 'corona' ) . '</span> <span class="nav-title"><span class="nav-title-icon-wrapper">' . ftc_get_svg( array( 'icon' => 'arrow-left' ) ) . '</span>%title</span>',
						'next_text' => '<span class="screen-reader-text">' . esc_html__( 'Next Post', 'corona' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . esc_html__( 'Next', 'corona' ) . '</span> <span class="nav-title">%title<span class="nav-title-icon-wrapper">' . ftc_get_svg( array( 'icon' => 'arrow-right' ) ) . '</span></span>',
					) );
