...
if( !class_exists('Ftc_Feedburner_Subscription_Widget') ){
	class Ftc_Feedburner_Subscription_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'feedburner-subscription', 'description' => esc_html__('Display Feedburner Subscriptions Form','corona'));
			$controlOps = array('width' => 400, 'height' => 550);
			parent::__construct('ftc_feedburner_subscription', esc_html__('FTC - Feedburner Subscription','corona'), $widgetOps, $controlOps);
		}
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('feedburner_id'); ?>"><?php esc_html_e('Enter your Feedburner ID', 'corona'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('intro_text'); ?>"><?php esc_html_e('Enter your Intro Text Line 1', 'corona'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('intro_text_2'); ?>"><?php esc_html_e('Enter your Intro Text Line 2', 'corona'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('button_text'); ?>"><?php esc_html_e('Enter your button text', 'corona'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('placeholder_text'); ?>"><?php esc_html_e('Placeholder text', 'corona'); ?> </label>
