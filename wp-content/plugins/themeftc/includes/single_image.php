		...
		?>
			...
			<p>
				...
				<select class="widefat" name="<?php echo $this->get_field_name('style_effect'); ?>" id="<?php echo $this->get_field_id('style_effect'); ?>">
					<option value="smooth-image" <?php selected('smooth-image', $instance['style_effect']) ?>><?php esc_html_e('Widespread Corner', 'themeftc') ?></option>
					<option value="smooth-border-image" <?php selected('smooth-border-image', $instance['style_effect']) ?>><?php esc_html_e('Border Scale', 'themeftc') ?></option>
