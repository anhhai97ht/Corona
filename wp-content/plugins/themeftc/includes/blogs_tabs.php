...
if( !class_exists('Ftc_Blogs_Tabs_Widget') ){
	class Ftc_Blogs_Tabs_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-blogs-tabs-widget', 'description' => esc_html__('Display popular and recent blogs in tabs', 'corona'));
			parent::__construct('ftc_blogs_tabs', esc_html__('FTC - Blogs Tabs', 'corona'), $widgetOps);
		}
		...
		?>
			<p>
				<label for="<?php echo $this->get_field_id('popular_title'); ?>"><?php esc_html_e('Popular tab title', 'corona'); ?> </label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('recent_title'); ?>"><?php esc_html_e('Recent tab title', 'corona'); ?> </label>
